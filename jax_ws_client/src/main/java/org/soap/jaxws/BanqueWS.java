 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://jax_ws_serveur.soap.com/", wsdlLocation = "http://192.168.31.213:18585/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://jax_ws_serveur.soap.com/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.31.213:18585/BanqueWS?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://jax_ws_serveur.soap.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jax_ws_serveur.soap.com/", "BanqueServicePort"), BanqueService.class, features);
    }
